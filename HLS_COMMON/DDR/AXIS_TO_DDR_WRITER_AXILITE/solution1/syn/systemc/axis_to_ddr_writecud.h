...
// ==============================================================
#ifndef __axis_to_ddr_writecud__HH__
#define __axis_to_ddr_writecud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(axis_to_ddr_writecud) {
    ...
    SC_CTOR(axis_to_ddr_writecud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
