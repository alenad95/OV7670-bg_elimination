...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Background_subtractor.autotvin.dat"
	set constFileTvOut       "Background_subtractor.autotvout.dat"
	set constFileHdlTvIn     "Background_subtractor.autohdltvin.dat"
	set constFileHdlTvOut    "Background_subtractor.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
