...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Background_subtractor.autotvin_stream_in_V.dat"
         "c.Background_subtractor.autotvin_enable_V.dat"
         "c.Background_subtractor.autotvin_stream_out_V.dat"
         "c.Background_subtractor.autotvout_frame_done_V.dat"
         "c.Background_subtractor.autotvout_stream_out_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Background_subtractor.autotvout_frame_done_V.dat"
         "rtl.Background_subtractor.autotvout_stream_out_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
