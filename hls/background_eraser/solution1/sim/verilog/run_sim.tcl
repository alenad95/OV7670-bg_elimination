...
if {[file isfile Background_subtractor.autotvin.dat]} {
	file delete -force Background_subtractor.autotvin.dat
}

if {[file isfile Background_subtractor.autotvout.dat]} {
	file delete -force Background_subtractor.autotvout.dat
}
